 ...
 *
 */
public class EmprestimoDisponibilidadeTM extends AbstractTableModel {
    ...
    public EmprestimoDisponibilidadeTM(List<Exemplar> lista) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                return f.getId();
            case 1:
                return f.getLivro().getTitulo();
            case 2:
                return f.getLivro().getAutor();
            case 3:
                return f.getEdicao();
            case 4:
