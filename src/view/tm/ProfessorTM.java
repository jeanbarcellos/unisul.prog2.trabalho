...
public class ProfessorTM extends AbstractTableModel {
    ...
    private String[] colunas = new String[]{"ID", "Nome", "Matrícula"};

    public ProfessorTM() {
        linhas = new ArrayList<Professor>();
    }

    public ProfessorTM(List<Professor> lista) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        Professor f = linhas.get(rowIndex);
    ...
    public void setValueAt(Professor aValue, int rowIndex) {
        Professor f = linhas.get(rowIndex); // Carrega o item da linha que deve ser modificado
    ...
    public void addProfessor(Professor f) {
        // Adiciona o registro.
        linhas.add(f);
    ...
    public void addLista(List<Professor> f) {
