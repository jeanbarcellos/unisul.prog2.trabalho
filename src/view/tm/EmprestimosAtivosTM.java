 ...
 *
 */
public class EmprestimosAtivosTM extends AbstractTableModel {
    ...
    public EmprestimosAtivosTM(List<Emprestimo> lista) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {            
            ...
            case 3:
                return f.getUsuario().getMatricula()+ " " + f.getUsuario().getNome();
            case 4:
                return EmprestimoControl.tipoUsuario(f);
            case 5:                                
